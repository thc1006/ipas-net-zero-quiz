...
export const PRIMARY: readonly HostRule[] = [
  ...
  // 網域是 .org.tw，但頁尾寫著「Copyright ©2011-2026 **經濟部國際貿易署**版權所有」
  ...
  { host: 'there100.org', who: 'RE100 國際倡議 —— RE100 規則與會員名單（2026-08 起 301 轉址至 theclimategroup.org）' },
  { host: 'theclimategroup.org', who: 'Climate Group —— RE100／EV100／EP100 的主辦機構，RE100 會員名單現址' },
